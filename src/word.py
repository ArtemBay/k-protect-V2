...
def hms(sec: float):
    ...
    if sec < 1:
        ...
        return f'{w} ' \
               f'{word_correct(w, "неделя", "недели", "недель")} {display_d}{display_h}{display_m}{display_s}'.strip()
...
def hms2(sec: float):
    ...
    if sec < 1:
        ...
        return f'{w} ' \
               f'{word_correct(w, "неделю", "недели", "недель")} {display_d}{display_h}{display_m}{display_s}'.strip()
